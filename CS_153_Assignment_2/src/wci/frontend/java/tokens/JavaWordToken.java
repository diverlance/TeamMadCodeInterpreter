 ...
 *
 * <p>Copyright (c) 2009 by Ronald Mak and Tem MadCode</p>
...
public class JavaWordToken extends JavaToken
{
        ...
        throws Exception
    {
        ...
        while (Character.isJavaIdentifierStart(currentChar)) {
        ...
        type = (RESERVED_WORDS.contains(text))					// Java case sensitivity
